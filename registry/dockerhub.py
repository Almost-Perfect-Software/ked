...
class DockerhubRegistry(BaseRegistry):
    def __init__(self, config: Dict[str, Any]):
        ...
        self.POLL_INTERVAL_SECONDS = self.config.get("dockerhub", {}).get("poll_interval_seconds") or int(
    ...
    def get_repository_images(self, repo: str) -> List[Tuple[str, str]]:
        ...
        while True:
            ...
            resp = requests.get(url, auth=(self.DOCKERHUB_USER, self.DOCKERHUB_PASS))
