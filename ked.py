...
def resolve_component_names(cfg: Dict[str, Any]) -> Dict[str, str]:
    ...
    """
    messenger_name = (cfg.get("messenger") or os.environ.get("messenger") or "slack").strip().lower()
    registry_name = (cfg.get("monitor") or os.environ.get("monitor") or "ecr").strip().lower()
